...
focus, compact-only primary Next hierarchy with Atlas-retained local import, explicit
lesson completion/review/final-scene Explore plus no-WebGL closeout, 200%-equivalent layout

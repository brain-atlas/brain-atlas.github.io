...
effective targets, selective reduced-motion CSS and settled-playback checks, 200%-equivalent
layout checks, and canonical visibility-driven asset requests. `power-rendering.spec.cjs` uses the

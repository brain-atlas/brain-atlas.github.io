...
effective targets, selective reduced-motion CSS and settled-playback checks, parsed semantic
theme-token coverage, 200%-equivalent layout checks, and canonical visibility-driven asset
